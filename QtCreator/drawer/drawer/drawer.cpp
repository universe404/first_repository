    ...
    : QToolBox( parent, f )
{
    ...
    toolButton3_1->setIcon( QPixmap( ":/images/qqimg/3.png" ) );
    toolButton3_1->setIconSize( QPixmap( ":/images/qqimg/3.png").size() );
    ...
    toolButton3_2->setIcon( QPixmap( ":/images/qqimg/4.png") );
    toolButton3_2->setIconSize( QPixmap( ":/images/qqimg/4.png").size() );
